...
export const translations = {
  'pt-BR': {
    ...
    admin: {
      ...
      // Áreas de governança
      adminAreasTitle: 'Áreas de Governança',
      adminAreasSubtitle: 'Gerencie áreas, processos e defina responsáveis',
      newArea: 'Nova Área',
      noAreas: 'Nenhuma área cadastrada',
      noAreasSubtitle: 'Crie áreas para organizar seus times e processos',
      createFirstArea: 'Criar primeira área',
      defaultArea: 'Padrão',
      manageAdmins: 'Gerenciar Administradores',
      editArea: 'Editar Área',
      deleteArea: 'Excluir Área',
      adminsCount: '{count} administradores',
      teamsCount: '{count} times',
      areaName: 'Nome',
      areaNamePlaceholder: 'Ex: Tecnologia, Comercial, RH...',
      areaDescription: 'Descrição',
      areaDescriptionPlaceholder: 'Descreva o propósito desta área...',
      areaColor: 'Cor',
      areaCreated: 'Área criada com sucesso',
      areaUpdated: 'Área atualizada com sucesso',
      areaDeleted: 'Área excluída com sucesso',
      areaDeleteConfirm: 'Tem certeza que deseja excluir a área "{name}"?',
      defaultAreaDeleteError: 'Não é possível excluir a área padrão',
      areaNameRequired: 'Nome da área é obrigatório',
      areaAdminsTitle: 'Administradores da Área',
      areaAdminsSubtitle: '{name} - Gerencie quem pode administrar esta área',
      governanceUpdated: 'Governança atualizada com sucesso',
      selectUser: 'Selecione um usuário',
      noAdmins: 'Nenhum administrador definido',
  ...
  'en-US': {
    ...
    admin: {
      ...
      editTeam: 'Edit Team',
      // Governance areas
      adminAreasTitle: 'Governance Areas',
      adminAreasSubtitle: 'Manage areas, processes and define responsibilities',
      newArea: 'New Area',
      noAreas: 'No areas registered',
      noAreasSubtitle: 'Create areas to organize your teams and processes',
      createFirstArea: 'Create first area',
      defaultArea: 'Default',
      ...
      areaName: 'Name',
      areaNamePlaceholder: 'E.g.: IT, Sales, HR...',
      areaDescription: 'Description',
      areaDescriptionPlaceholder: 'Describe the purpose of this area...',
      areaColor: 'Color',
      areaCreated: 'Area created successfully',
      areaUpdated: 'Area updated successfully',
      areaDeleted: 'Area deleted successfully',
      areaDeleteConfirm: 'Are you sure you want to delete the area "{name}"?',
      defaultAreaDeleteError: 'Cannot delete default area',
      areaNameRequired: 'Area name is required',
      areaAdminsTitle: 'Area Administrators',
      areaAdminsSubtitle: '{name} - Manage who can administer this area',
      governanceUpdated: 'Governance updated successfully',
      selectUser: 'Select a user',
      noAdmins: 'No administrators defined',
