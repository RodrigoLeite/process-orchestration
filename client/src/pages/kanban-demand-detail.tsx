  ...
  if (isLoading || !demand) {
    return (
      <div className="flex flex-col items-center justify-center py-16 gap-4">
        ...
        <p className="text-muted-foreground">Carregando workflow da demanda...</p>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl md:text-5xl font-bold">Workflow da Demanda</h1>
        ...
        <Card className="border-yellow-500/20">
          <CardContent className="pt-6 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-foreground">Esta demanda ainda não possui workflow gerado.</p>
                <p className="text-sm text-muted-foreground mt-2">
                  O workflow será criado assim que o agente processar e rotear a demanda.
                </p>
              </div>
            </div>
          </CardContent>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1" data-testid="text-progress">
              {demandColumnIndex + 1} de {sortedFlow.length} etapas
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">SLA Total</CardTitle>
          </CardHeader>
          <CardContent>
