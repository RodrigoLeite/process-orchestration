        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-4 lg:grid-cols-7">
            {[
              ...
              <div key={roleKey} className="p-4 border rounded-lg text-center flex flex-col items-center">
                <Shield className="h-8 w-8 mx-auto mb-2 text-primary" />
                <h4 className="font-medium text-sm">{t(`admin.roleNames.${roleKey}`)}</h4>
                <p className="text-[10px] text-muted-foreground mt-1 leading-tight">
                  {t(`admin.roleDescriptions.${roleKey}`)}
                </p>
              </div>
            ))}
          </div>
